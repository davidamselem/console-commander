...
XXCOPY == Freeware ==  Release  Version 3.33.3  (2016-10-28)

  Thank you for your interest in the XXCOPY freeware package.
  ...
  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  ...
  xxcopy.zip or xxfw3333.zip), unzip it into a temporary
  directory (e.g., c:\temp).
  ...
  xxpbar.exe     ; The Progress Bar display module
  xxconsole.exe  ; a Super Console Generator
  xxcopy.chm     ; HTML-style help file
  uixxcopy.bat   ; uninstall the xxcopy*.exe files  README.TXT     ; this file
...
please contact Pixelab for further discussions.
  ...
  +--------------------------------------------------------------+
  |  (c)1995-2016 Copyright  Pixelab        All rights reserved. |
